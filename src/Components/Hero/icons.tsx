export function SwachhBharatIcon({ className = "" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ReduceIcon({ className = "" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function ReuseIcon({ className = "" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function CircularEconomyIcon({ className = "" }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M8.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" fill="currentColor" />
      <path d="M15.5 11a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" fill="currentColor" />
    </svg>
  );
}

export function GreenEnergyIcon({ className = "" }) {
  return (
    <svg
      fill="currentColor"
      height="200px"
